...
abstract class Controller {
    ...
    protected function render($view, array $data = []){
        // Token CSRF disponible en todas las vistas como $csrfField
    ...
    /**
     * Genera o reutiliza un token CSRF almacenado en la sesion.
     */
    ...
    /**
     * Devuelve un campo hidden HTML listo para insertar en formularios POST.
     */
    ...
    /**
     * Valida que el token enviado en POST coincida con el de la sesion.
     * Si falla, aborta con 403.
     */
    protected function verifyCsrfToken(){
        $token = $this->postString('csrf_token');
        if(!hash_equals($_SESSION['csrf_token'] ?? '', $token)){
            $this->abort('Token CSRF invalido. Recarga la pagina e intenta de nuevo.', 403);
        }
    }

    // -- Validacion de entrada contra inyecciones SQL --
